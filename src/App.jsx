...
const GRADES = {
  ...
  11: { label: "Juniors",    color: "#4a4a4a", text: "#ffffff", pill: "rgba(74,74,74,0.4)",
        tabColor: "#888888" }, // visible on dark bg while still reading as "black"
...
export default function App() {
  ...
  const acc    = g.color;
  // For tab label use tabColor if defined (Juniors needs a lighter shade to be visible)
  ...
  return (
    <div style={{ background: "#12103a", minHeight: "100vh", fontFamily: "system-ui, sans-serif" }}>
      ...
      <div style={{ padding: "12px 16px", display: "flex", gap: 8, flexWrap: "wrap", alignItems: "center", borderBottom: "1px solid #1e1c4a" }}>
        ...
        {/* Add Task — always visible, shows error toast if script not set up yet */}
